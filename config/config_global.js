	...
	homepage_sections: [

		{
			...
			sub_cat: [{
					...
					content: [{
						...
						// description: 'asfaf asfa sfsf sd',
						image: '/dist/finalImages/sightseeing_featured/tanah_lot_temple.jpg'
					}, {
						title: 'Uluwatu Temple',
						// description: 'asfaf asfa sfsf sd',
						image: '/dist/finalImages/sightseeing_featured/uluwatu_temple.jpg'
					}, {
						title: 'Ulun Danu Bratan Temple',
						// description: 'asfaf asfa sfsf sd',
						image: '/dist/finalImages/sightseeing_featured/ulun_danu_temple.jpg'
					}, {
						title: 'Borobudur Temple',
						// description: 'asfaf asfa sfsf sd',
						image: '/dist/finalImages/sightseeing_featured/borobudur_temple.jpg'
					}]
				}
		...
		, {
			...
			categories: [{
				...
				title: 'Hot Springs',
				// description: 'asfaf asfa sfsf sd',
				image: '/dist/finalImages/nature/hot_springs.jpg'
			}, {
				title: 'Canyons',
				// description: 'asfaf asfa sfsf sd',
			...
			sub_cat: [{
					...
					content: [{
						...
						title: 'Lake Toba',
						// description: 'asfaf asfa sfsf sd',
						image: '/dist/finalImages/nature_featured/lake_toba.jpg'
					}, {
						title: 'White Crater Lake',
						// description: 'asfaf asfa sfsf sd',
						image: '/dist/finalImages/nature_featured/white_crater_ ciwidey.jpg'
					}]
				}
		...
		, {
			...
			categories: [{
				title: 'Wellness & Yoga',
				// description: 'asfaf asfa sfsf sd',
				image: '/dist/finalImages/classes/wellness_classes.jpg'
			}, {
				title: 'Cooking Classes',
				// description: 'asfaf asfa sfsf sd',
				image: '/dist/finalImages/classes/cooking_classes.jpg'
			}, {
				title: 'Art Classes',
				// description: 'asfaf asfa sfsf sd',
				image: '/dist/finalImages/classes/art_classes.jpg'
			}, {
				title: 'Jewellery Making Workshops',
				// description: 'asfaf asfa sfsf sd',
				image: '/dist/finalImages/classes/jewellery_making.jpg'
			}]
