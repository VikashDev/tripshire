(function() {
    ...
    app.controller('homeController', ['$scope', '$rootScope', function($scope, $rootScope) {
        ...
        console.log('Page header ctrl');

        $scope.test = "Hello";

    }]);

    app.controller('globalController', ['$scope', '$rootScope', '$timeout','$http', function($scope, $rootScope, $timeout, $http) {
        ...
        $scope.submit = function() {
            ...
            $http.post('/v1/api/admin/login', $scope.login).then(function success(response){
